...
<div class="section" id="passwords-admin">
	...
	<div>
		...
		<p><?php p($l->t('Installed') . ': v' . $updateChecker->getLocalVersion()); ?></p>

		<?php
			if ($updateChecker->hasUpdate()) { ?>
				<p>
				<strong><?php p($l->t('Available') . ': v' . $updateChecker->getGitHubVersion()); ?></strong>
				</p>
				<br>
				<a href="https://github.com/marius-wieschollek/passwords-legacy/archive/stable.zip" class="button"><?php p($l->t('Download %s', 'ZIP')); ?></a>
				<a href="https://github.com/marius-wieschollek/passwords-legacy/archive/stable.tar.gz" class="button"><?php p($l->t('Download %s', 'TAR')); ?></a>
				<br>
				<br>
				<a href="https://github.com/marius-wieschollek/passwords-legacy/blob/stable/CHANGELOG.md" class="button" target="_blank"><?php p($l->t('List of changes since %s', 'v' . $updateChecker->getLocalVersion())); ?></a>
				<a href="https://github.com/marius-wieschollek/passwords-legacy/releases" class="button" target="_blank"><?php p($l->t('View all releases')); ?></a>
				<a href="https://github.com/marius-wieschollek/passwords-legacy" class="button" target="_blank"><?php p($l->t('Visit %s', 'GitHub')); ?></a>
				<br>
				<br>
				<p><?php p($l->t('Or update with CLI')); ?>:</p>
				<p class="gitcode">sudo rm -rf <?php p($app_path); ?>/passwords</p>
				<p class="gitcode">sudo git clone https://github.com/marius-wieschollek/passwords-legacy.git <?php p($app_path); ?>/passwords</p>
